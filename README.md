...
|[Twitter Gallery](https://github.com/emrecoban/twitter-gallery)|A Next.js application that allows you to easily browse and filter media files from Twitter users.|Next.js, TailwindCSS, Twitter API SDK|
...
[Blog](https://emrecoban.github.io) · [CV](https://github.com/emrecoban/emrecoban.github.io/blob/main/Emre_COBAN_CV-ENG_v2.pdf)
<!--
